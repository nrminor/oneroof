...
- `tests/modules/` - Unit tests for individual processes
- `tests/workflows/` - Integration tests for platform-specific workflows
- `tests/pipelines/` - End-to-end pipeline tests
- `tests/data/` - Minimal test datasets
