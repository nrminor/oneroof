...
**refman.toml**
- Reference management configuration
- May be used for managing citations or references in documentation
...
**data_manifest.yml**
- Data file manifest configuration
- May define expected data structures or test data locations
...
**my_script.ml** & **my_script.mli**
- OCaml source files (interface and implementation)
- Purpose unclear - may be experimental or legacy
- Could be related to performance-critical components
...
**python_respliced.bed** & **rust_respliced.bed**
- Output from resplicing scripts
- Comparison/testing artifacts
- May be temporary

**test.vcf** & **test_all_hap.vcf**
- Test VCF outputs
